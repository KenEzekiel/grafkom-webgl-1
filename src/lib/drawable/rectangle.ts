...
export class Rectangle extends Drawable {
  ...
  constructor(public point: Point, public width: number, public height: number, color: Color, application: ApplicationProgram) {
  ...
  draw(): void {
    this.program.gl.bufferData(
      ...
      new Float32Array(this.calculateRectangle(this.point.x, this.point.y, this.width, this.height)),
